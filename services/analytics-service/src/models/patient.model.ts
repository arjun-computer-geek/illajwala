...
// This model should be accessed via identity-service or provider-service
...
const PatientSchema = new Schema<PatientDocument>(
  {
    ...
    notificationPreferences: {
      ...
      whatsappReminders: {
        type: Boolean,
        default: defaultNotificationPreferences.whatsappReminders,
      },
      waitlistReminders: {
        type: Boolean,
        default: defaultNotificationPreferences.waitlistReminders,
      },
    },
  },
  { timestamps: true },
